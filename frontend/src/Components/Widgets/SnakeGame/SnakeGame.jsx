...
//   return props.snakeColor
// }
class SnakeGame extends React.Component {
  constructor(props) {
    super(props)
    console.log('inside snake game')
  ...
  // This is the way it should be to not get the warning but doesnt render random color at first
  // static getDerivedStateFromProps(nextProps, prevState) {
  //   if (nextProps !== prevState) {
  //     return ({ snakeColor: nextProps.snakeColor }) // <- this is setState equivalent
  //   }
  //   return null
  // }

  UNSAFE_componentWillReceiveProps(nextProps) {
    this.setState({ snakeColor: nextProps.snakeColor, appleColor: nextProps.appleColor});  
  }
