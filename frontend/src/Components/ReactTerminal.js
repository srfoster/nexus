...
function ReactTerminal(props) {
  ...
  const commands = {
    ...
    setOrbColor: {
      ...
      usage: 'setOrbColor <color>',
      fn: function () {
        return (
          props.setOrbColor(Array.from(arguments))
        )
      }
    },
    renderTextBoxes: {
      description: 'Displays textboxes for easy color changing',
      usage: 'renderTextBoxes',
      fn: function () {
        return (
          props.setShowTextBoxes(true)
        )
      }
    },
  }
